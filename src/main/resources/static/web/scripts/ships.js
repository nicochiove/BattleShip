...
const createShips = function(shipType, length, orientation, parent, isStatic){
    ...
    if(!isStatic){
        ...
        grip.addEventListener('dragend',checkShipsLocated)
...
//CHEQUEA SI LOS BARCOS FUERON ARRASTRADOS HASTA LA GRILLA, CUANDO ARRASTRAS TODOS TE HABILITA EL BOTON
function checkShipsLocated(){
    
    let children= document.getElementById('dock').children
    let names= ["bergantin","fragata","goleta","carabela","galeon"]
